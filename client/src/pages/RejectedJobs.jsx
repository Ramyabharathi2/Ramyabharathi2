...
const RejectedJobs = () => {
  ...
  const [testDate, setTestDate] = useState("");  // Add state for testDate
  ...
  return (
    ...
    <div className="container mx-auto p-4">
      <h2 className="text-3xl font-bold text-center mb-4">Rejected Job </h2>
      ...
      {/* Date Picker (if required for test date scheduling) */}
