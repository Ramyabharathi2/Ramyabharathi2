...
const ApplicationsTable = () => {
  ...
  useEffect(() => {
    axios.get("http://localhost:5000/api/job/all/applications").then((res) => {
  ...
  return (
    ...
    <div className="p-6 max-w-7xl mx-auto">
      <h2 className="text-3xl font-bold mb-6 text-gray-800">All Job Applications</h2>
                ...
                <td className="p-3 border-b text-sm text-green-700">
                  <div className="flex flex-col gap-1" style={{display:"flex",gap:"15px"}}>
                    <a href={`tel:${app.phone}`} className="hover:underline">
                     <span style={{color:'green',backgroundColor:"blue",fontSize:"24px",borderRadius:"10px"}}>📞</span> {app.phone}
                    </a>
                    <a
                    ...
                    >
                      <span style={{color:'green',backgroundColor:"green",fontSize:"24px",borderRadius:"10px"}}>💬</span> WhatsApp
                    </a>
                  </div>
                </td>
